...
<html>
    ...
    <body>
        ...
        <div class="cadre">
            ...
            <a class='pure-button pure-button-primary' href='./general'>General</a><br><br>
            <a class='pure-button pure-button-primary' href='./video'>Video</a><br><br>
	<a class='pure-button pure-button-primary' href='./sound'>Sound</a><br><br>
</center>
            </div>
        </div>
