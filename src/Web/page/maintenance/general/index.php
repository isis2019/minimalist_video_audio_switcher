...
<html>
    ...
    <body>
        ...
        <div class="cadre">
            ...
            <a class='pure-button pure-button-primary' href='./info_pc.php'>PC caracteristics</a><br><br>
		<a class='pure-button pure-button-primary' href='./function.php?restart'>Restart computer</a><br><br>
</center>
            </div>
        </div>
